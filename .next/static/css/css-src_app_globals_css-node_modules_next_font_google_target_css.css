...
samp,
pre {
  font-family: ui-monospace, SFMono-Regular, monospace; /* 1 */
...
.border-accent {
  --tw-border-opacity: 1;
  border-color: rgb(79 124 255 / var(--tw-border-opacity, 1));
}
.border-accent\/20 {
  border-color: rgb(79 124 255 / 0.2);
}
.border-accent\/40 {
  border-color: rgb(79 124 255 / 0.4);
}
.border-border {
  --tw-border-opacity: 1;
  border-color: rgb(20 28 46 / var(--tw-border-opacity, 1));
}
.border-transparent {
...
.bg-accent {
  --tw-bg-opacity: 1;
  background-color: rgb(79 124 255 / var(--tw-bg-opacity, 1));
}
.bg-accent\/5 {
  background-color: rgb(79 124 255 / 0.05);
}
.bg-bg {
  --tw-bg-opacity: 1;
...
.via-accent {
  --tw-gradient-to: rgb(79 124 255 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), #4f7cff var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.to-transparent {
...
.text-accent {
  --tw-text-opacity: 1;
  color: rgb(79 124 255 / var(--tw-text-opacity, 1));
}
.text-accent-dim {
  --tw-text-opacity: 1;
  color: rgb(45 79 160 / var(--tw-text-opacity, 1));
}
.text-accent\/60 {
  color: rgb(79 124 255 / 0.6);
}
.text-accent\/70 {
  color: rgb(79 124 255 / 0.7);
}
.text-bg {
  --tw-text-opacity: 1;
  color: rgb(6 8 15 / var(--tw-text-opacity, 1));
}
.text-muted {
  --tw-text-opacity: 1;
...
.text-text-secondary {
  --tw-text-opacity: 1;
  color: rgb(136 146 164 / var(--tw-text-opacity, 1));
}
.opacity-0 {
  opacity: 0;
}
...
::-webkit-scrollbar-thumb { background: #1e2a45; border-radius: 1px; }
...
.scroll-progress {
  ...
  left: 0;
  height: 1px;
  background: linear-gradient(90deg, #4f7cff, #a5b4fc, #4f7cff);
  z-index: 9998;
  transform-origin: left;
}
...
.shimmer {
  background: linear-gradient(90deg, #4f7cff 0%, #a5b4fc 40%, #4f7cff 60%, #818cf8 100%);
...
@keyframes badge-pulse {
  0%, 100% { box-shadow: 0 0 10px rgba(79,124,255,0.3), 0 0 20px rgba(79,124,255,0.1); }
  50% { box-shadow: 0 0 20px rgba(79,124,255,0.5), 0 0 40px rgba(79,124,255,0.2); }
}

.clair-badge { animation: badge-pulse 3s ease-in-out infinite; }
...
.featured-border::before {
  ...
  background: linear-gradient(135deg, rgba(79,124,255,0.4), transparent, rgba(165,180,252,0.15));
  z-index: -1;
}
...
.hover\:border-accent\/30:hover {
  border-color: rgb(79 124 255 / 0.3);
}
